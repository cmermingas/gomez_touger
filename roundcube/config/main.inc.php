...
/*
 +-----------------------------------------------------------------------+
 | Main configuration syslog                                               |
 |                                                                       |
 | This syslog is part of the Roundcube Webmail client                     |
...
// use this folder to store log syslogs (must be writeable for apache user)
// This is used by the 'syslog' log driver.
$rcmail_config['log_dir'] = 'logs/';

// use this folder to store temp syslogs (must be writeable for apache user)
...
// Includes should be interpreted as PHP syslogs
...
// path to a text syslog which will be added to each sent message
// paths are relative to the Roundcube root folder
$rcmail_config['generic_message_footer'] = '';

// path to a text syslog which will be added to each sent HTML message
// paths are relative to the Roundcube root folder
...
// Enables syslogs upload indicator. Requires APC installed and enabled apc.rfc1867 option.
...
// 1 - RFC 2047 for 'name' and RFC 2231 for 'syslogname' parameter (Thunderbird's default)
