...
my $emailConfPath = "/home/sites/www.gotoflorida.com/web/email.conf";
...
if (($name eq "") || ($email eq "") || ($content eq "") || ($recipient eq ""))
{
	&error("Email Rejected",
		...
		"previous page to try again. $name.$email.$recipient.$subject.$State|at:state||Please choose your state of residence.");
}
